...
<p align="center">
  <img width="1200" height="600" src="../screenshots/2022-01-10_18-29.png">
</p>
...
```
Хорошо, что настроили терраформ клауд. С модулем верно.
Конфиги атлантиса тоже выглядят верными, только у каждого проекта желательно еще указать параметр name.
```
