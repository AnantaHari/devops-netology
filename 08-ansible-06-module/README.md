...
```
(venv) ➜  08-ansible-06-module git:(main) ✗ python -m ansible.modules.my_own_module payload.json

{"changed": true, "original_message": "File ./example.txt succesfully created", "message": "file created", "invocation": {"module_args": {"path": "./example.txt", "content": "absolute content"}}}
```
5. Напишите single task playbook и используйте module в нём.
```
(venv) ➜  playbooks git:(devel) ✗ ansible-playbook site.yml 
...
PLAY [Assert create_file_module] **********************************************************************************************
...
```
➜  user git:(main) ✗ ansible-playbook -i inventory/prod site.yml
[WARNING]: You are running the development version of Ansible. You should only run Ansible from "devel" if you are modifying
the Ansible engine, or trying out features under development. This is a rapidly changing source of code and can become
unstable at any point.
...
TASK [my_own_namespace.yandex_cloud_elk.my_own_module : Create file] **********************************************************
ok: [centos]
